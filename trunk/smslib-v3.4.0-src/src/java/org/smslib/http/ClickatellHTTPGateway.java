...
public class ClickatellHTTPGateway extends HTTPGateway
{
	...
	public void startGateway() throws TimeoutException, GatewayException, IOException, InterruptedException
	{
		...
		connect();
		setKeepAlive(new KeepAlive("KeepAlive [" + getGatewayId() + "]", getService()));
		getService().getScheduler().scheduleAtFixedRate(getKeepAlive(), 60, 60, TimeUnit.SECONDS);
		getKeepAlive().enable();
		super.startGateway();
	}
	...
	public void stopGateway() throws TimeoutException, GatewayException, IOException, InterruptedException
	{
		...
		getService().getScheduler().remove(getKeepAlive());
		super.stopGateway();
		this.sessionId = null;
	}
	...
	class KeepAlive extends ASchedulerTask
	{
	...
	void setKeepAlive(KeepAlive myKeepAlive)
	{

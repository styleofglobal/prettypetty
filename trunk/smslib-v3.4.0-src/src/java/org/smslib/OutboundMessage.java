...
public class OutboundMessage extends Message
{
	...
	private String userDefaultRoute;
	...
	protected void copyTo(OutboundMessage msg)
	{
		...
		msg.setUserDefaultRoute(getUserDefaultRoute());
	}

	/**
	 * Returns the original (user requested) message routing information.
	 * 
	 * @return The original routing requested at the creation of the message.
	 */
	public String getUserDefaultRoute()
	{
		return userDefaultRoute;
	}

	protected void setUserDefaultRoute(String myUserDefaultRoute)
	{
		this.userDefaultRoute = myUserDefaultRoute;
	}

	/**
	 * Sets the message's Gateway ID to a specific value. Overrides the default
	 * method in order to set the userDefaultRoute indicator.
	 * 
	 * @param myGtwId
	 *            The Gateway ID.
	 * @see #getGatewayId()
	...
	{
		if (getUserDefaultRoute() == null) setUserDefaultRoute(myGtwId);
		super.setGatewayId(myGtwId);
	}
}

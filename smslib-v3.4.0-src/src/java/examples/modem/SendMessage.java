...
public class SendMessage
{
	...
	{
		//safaricom service center number +254722500029
		Service srv;
		OutboundMessage msg;
		...
		srv = new Service();
		SerialModemGateway gateway = new SerialModemGateway("Safaricom", "COM9", 9600, "Huawei", "E220");
		gateway.setInbound(true);
		gateway.setOutbound(true);
		gateway.setSmscNumber("+254722500029");
		//gateway.setSimPin("1354");
		...
		msg = new OutboundMessage("144", "balance");
		srv.sendMessage(msg);
